...
(define (open-midi1) (rtmidi-open-port out 1))

(define midi-send-message rtmidi-send-message)
...
;; (unless (empty? in-ports) (rtmidi-open-port in 0))

;; (unless (empty? out-ports) (rtmidi-open-port out 0))
